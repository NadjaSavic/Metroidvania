...
public class Movement : MonoBehaviour
{
    ...
    private void Jump(Vector2 direction)
    {
        ...
        {
            AudoManager.instance.Play("Jump_2");
            _extraJumpsValue--;
            _anim.SetBool("isDoubleJumping",true);
        }
        else  _anim.SetBool("isDoubleJumping",false);

        _isJumping = true;
        AudoManager.instance.Play("Jump_1");
    ...
    IEnumerator Dash(float x, float y)
    {
        ...
        AudoManager.instance.Play("Dash");
     ...
     void Animation()
    {
        ...
        else
        {
            ...
            if ((_horizontalDirection < 0f && _facingRight || _horizontalDirection > 0f && !_facingRight) && !_wallGrab)
            {
                Flip();
            }
            if (_onGround)
